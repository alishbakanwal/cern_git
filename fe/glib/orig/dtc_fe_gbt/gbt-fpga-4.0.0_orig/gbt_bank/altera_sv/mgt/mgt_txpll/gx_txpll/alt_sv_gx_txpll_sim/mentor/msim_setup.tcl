...
# # End of template
# ----------------------------------------
# If alt_sv_gx_txpll is one of several IP cores in your
...
# ----------------------------------------
# ACDS 15.1 185 linux 2016.03.18.14:42:44
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "alt_sv_gx_txpll"
}
...
ensure_lib                 ./libraries/alt_sv_gx_txpll/
vmap       alt_sv_gx_txpll ./libraries/alt_sv_gx_txpll/
...
alias com {
  echo "\[exec\] com"
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_pll_sv/altera_xcvr_functions.sv"             -work alt_sv_gx_txpll
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_pll_sv/mentor/altera_xcvr_functions.sv"      -work alt_sv_gx_txpll
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_pll_sv/sv_xcvr_h.sv"                         -work alt_sv_gx_txpll
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_pll_sv/sv_xcvr_plls.sv"                      -work alt_sv_gx_txpll
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_pll_sv/sv_reconfig_bundle_to_xcvr.sv"        -work alt_sv_gx_txpll
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_pll_sv/sv_xcvr_avmm_csr.sv"                  -work alt_sv_gx_txpll
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_pll_sv/mentor/sv_xcvr_h.sv"                  -work alt_sv_gx_txpll
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_pll_sv/mentor/sv_xcvr_plls.sv"               -work alt_sv_gx_txpll
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_pll_sv/mentor/sv_reconfig_bundle_to_xcvr.sv" -work alt_sv_gx_txpll
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_pll_sv/mentor/sv_xcvr_avmm_csr.sv"           -work alt_sv_gx_txpll
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_pll_sv/alt_xcvr_resync.sv"                   -work alt_sv_gx_txpll
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_pll_sv/mentor/alt_xcvr_resync.sv"            -work alt_sv_gx_txpll
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/alt_sv_gx_txpll.vhd"                                                          
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L alt_sv_gx_txpll -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L stratixv_ver -L stratixv_hssi_ver -L stratixv_pcie_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L stratixv -L stratixv_hssi -L stratixv_pcie_hip $TOP_LEVEL_NAME
}
