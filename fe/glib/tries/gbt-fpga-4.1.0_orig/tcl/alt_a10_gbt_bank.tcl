...
#                        26/02/2016   4.1       Julian Mendez     Removing QSYS component (not recommended by Altera)
#
...
set_global_assignment -name QSYS_FILE  $SOURCE_PATH/gbt_bank/altera_a10/gbt_rx/alt_ax_rx_dpram/alt_ax_rx_dpram.qsys
  
set_global_assignment -name VHDL_FILE  $SOURCE_PATH/gbt_bank/altera_a10/gbt_tx/alt_ax_gbt_tx_gearbox_std_dpram.vhd
set_global_assignment -name QSYS_FILE  $SOURCE_PATH/gbt_bank/altera_a10/gbt_tx/alt_ax_tx_dpram/alt_ax_tx_dpram.qsys
...
set_global_assignment -name QSYS_FILE  $SOURCE_PATH/gbt_bank/altera_a10/mgt/gx_latopt_x6/gx_latopt_x6.qsys
set_global_assignment -name QSYS_FILE  $SOURCE_PATH/gbt_bank/altera_a10/mgt/gx_latopt_x5/gx_latopt_x5.qsys
set_global_assignment -name QSYS_FILE  $SOURCE_PATH/gbt_bank/altera_a10/mgt/gx_latopt_x4/gx_latopt_x4.qsys
set_global_assignment -name QSYS_FILE  $SOURCE_PATH/gbt_bank/altera_a10/mgt/gx_latopt_x3/gx_latopt_x3.qsys
set_global_assignment -name QSYS_FILE  $SOURCE_PATH/gbt_bank/altera_a10/mgt/gx_latopt_x2/gx_latopt_x2.qsys
set_global_assignment -name QSYS_FILE  $SOURCE_PATH/gbt_bank/altera_a10/mgt/gx_latopt_x1/gx_latopt_x1.qsys
set_global_assignment -name QSYS_FILE  $SOURCE_PATH/gbt_bank/altera_a10/mgt/gx_std_x6/gx_std_x6.qsys
set_global_assignment -name QSYS_FILE  $SOURCE_PATH/gbt_bank/altera_a10/mgt/gx_std_x5/gx_std_x5.qsys
set_global_assignment -name QSYS_FILE  $SOURCE_PATH/gbt_bank/altera_a10/mgt/gx_std_x4/gx_std_x4.qsys
set_global_assignment -name QSYS_FILE  $SOURCE_PATH/gbt_bank/altera_a10/mgt/gx_std_x3/gx_std_x3.qsys
set_global_assignment -name QSYS_FILE  $SOURCE_PATH/gbt_bank/altera_a10/mgt/gx_std_x2/gx_std_x2.qsys
set_global_assignment -name QSYS_FILE  $SOURCE_PATH/gbt_bank/altera_a10/mgt/gx_std_x1/gx_std_x1.qsys

set_global_assignment -name QSYS_FILE  $SOURCE_PATH/gbt_bank/altera_a10/mgt/gx_reset_rx/gx_reset_rx.qsys
set_global_assignment -name QSYS_FILE  $SOURCE_PATH/gbt_bank/altera_a10/mgt/gx_reset_tx/gx_reset_tx.qsys

set_global_assignment -name VHDL_FILE  $SOURCE_PATH/gbt_bank/altera_a10/mgt/alt_ax_mgt_txpll.vhd
set_global_assignment -name QSYS_FILE  $SOURCE_PATH/gbt_bank/altera_a10/mgt/atx_pll_rst/mgt_atxpll_rst.qsys
set_global_assignment -name QSYS_FILE  $SOURCE_PATH/gbt_bank/altera_a10/mgt/fpll/mgt_pll.qsys
set_global_assignment -name QSYS_FILE  $SOURCE_PATH/gbt_bank/altera_a10/mgt/atx_pll/mgt_atxpll.qsys
...
set_global_assignment -name VHDL_FILE $SOURCE_PATH/example_designs/altera_a10/core_sources/gbt_rx_frameclk_phalgnr/phalgnr_std_pll.vhd
set_global_assignment -name VHDL_FILE $SOURCE_PATH/example_designs/altera_a10/core_sources/gbt_rx_frameclk_phalgnr/phaligner_mmcm_controller.vhd
set_global_assignment -name QSYS_FILE $SOURCE_PATH/example_designs/altera_a10/core_sources/gbt_rx_frameclk_phalgnr/rx_frameclk_pll/rx_frameclk_pll.qsys
...
set_global_assignment -name QSYS_FILE $SOURCE_PATH/example_designs/altera_a10/core_sources/alt_a10_reset/alt_a10_lpm_shiftreg.qsys
...
puts "-> Adding Altera Arria 10 top to the Quartus II project..."
puts "->" 
set_global_assignment -name VHDL_FILE $SOURCE_PATH/example_designs/altera_a10/core_sources/alt_ax_gbt_example_design.vhd
