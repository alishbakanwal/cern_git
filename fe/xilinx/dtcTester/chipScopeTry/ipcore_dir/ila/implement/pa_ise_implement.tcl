...
#-----------------------------------------------------------------------------
add_files -norecurse {../example_design/example_ila.v}
#add_files -norecurse {../example_design/example_ila.ucf}
set_property target_constrs_file {../example_design/example_ila.ucf} [current_fileset -constrset]
import_ip -file {chipscope_icon.xco} -name chipscope_icon
generate_target { all } [get_ips chipscope_icon]
set_property top example_ila [get_filesets sources_1]
