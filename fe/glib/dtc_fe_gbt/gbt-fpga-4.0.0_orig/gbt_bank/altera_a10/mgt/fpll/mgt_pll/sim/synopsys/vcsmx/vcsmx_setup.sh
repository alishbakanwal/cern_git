...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_xcvr_fpll_a10_151/sim/twentynm_xcvr_avmm.sv"          -work mgt_pll_altera_xcvr_fpll_a10_151
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_xcvr_fpll_a10_151/sim/alt_xcvr_resync.sv"             -work mgt_pll_altera_xcvr_fpll_a10_151
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_xcvr_fpll_a10_151/sim/altera_xcvr_fpll_a10.sv"        -work mgt_pll_altera_xcvr_fpll_a10_151
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_xcvr_fpll_a10_151/sim/a10_avmm_h.sv"                  -work mgt_pll_altera_xcvr_fpll_a10_151
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_xcvr_fpll_a10_151/sim/alt_xcvr_native_avmm_nf.sv"     -work mgt_pll_altera_xcvr_fpll_a10_151
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_xcvr_fpll_a10_151/sim/alt_xcvr_pll_embedded_debug.sv" -work mgt_pll_altera_xcvr_fpll_a10_151
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_xcvr_fpll_a10_151/sim/alt_xcvr_pll_avmm_csr.sv"       -work mgt_pll_altera_xcvr_fpll_a10_151
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/mgt_pll.vhd"                                                                                          
fi
