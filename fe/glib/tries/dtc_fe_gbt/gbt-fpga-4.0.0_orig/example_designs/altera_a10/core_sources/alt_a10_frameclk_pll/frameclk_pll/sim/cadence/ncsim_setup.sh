...
mkdir -p ./libraries/frameclk_pll_altera_iopll_151/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/../altera_iopll_151/sim/frameclk_pll_altera_iopll_151_va2pmui.vo" -work frameclk_pll_altera_iopll_151 -cdslib ./cds_libs/frameclk_pll_altera_iopll_151.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/frameclk_pll.vhd"                                                                                                                                             
fi
