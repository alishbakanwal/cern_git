...
mkdir -p ./libraries/frameclk_pll_altera_iopll_160/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../altera_iopll_160/sim/frameclk_pll_altera_iopll_160_tnwlaai.vo" -work frameclk_pll_altera_iopll_160 -cdslib ./cds_libs/frameclk_pll_altera_iopll_160.cds.lib
  ncvlog -compcnfg $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/frameclk_pll.v"                                                                                                                                               
fi
