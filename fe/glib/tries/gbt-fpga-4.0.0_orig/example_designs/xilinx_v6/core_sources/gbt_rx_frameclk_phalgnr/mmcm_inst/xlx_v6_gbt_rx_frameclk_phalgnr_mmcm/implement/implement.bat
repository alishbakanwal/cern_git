...
xst -ifn xst.scr
move xlx_v6_gbt_rx_frameclk_phalgnr_mmcm_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\xlx_v6_gbt_rx_frameclk_phalgnr_mmcm_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc xlx_v6_gbt_rx_frameclk_phalgnr_mmcm_exdes.ucf xlx_v6_gbt_rx_frameclk_phalgnr_mmcm_exdes

echo 'Running map'
map -timing -pr b xlx_v6_gbt_rx_frameclk_phalgnr_mmcm_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm xlx_v6_gbt_rx_frameclk_phalgnr_mmcm_exdes -w routed.ncd routed.vhd
cd ..
