...
xst -ifn xst.scr
move cdce_out4_mmcm_40M_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\cdce_out4_mmcm_40M_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc cdce_out4_mmcm_40M_exdes.ucf cdce_out4_mmcm_40M_exdes

echo 'Running map'
map -timing -pr b cdce_out4_mmcm_40M_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm cdce_out4_mmcm_40M_exdes -w routed.ncd routed.vhd
cd ..
