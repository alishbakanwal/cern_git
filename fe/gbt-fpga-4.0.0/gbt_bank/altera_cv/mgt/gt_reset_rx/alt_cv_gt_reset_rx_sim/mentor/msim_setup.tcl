...
# # End of template
# ----------------------------------------
# If alt_cv_gt_reset_rx is one of several IP cores in your
...
# ----------------------------------------
# ACDS 15.1 185 win32 2016.03.30.15:00:44
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "alt_cv_gt_reset_rx"
}
...
ensure_lib                    ./libraries/alt_cv_gt_reset_rx/
vmap       alt_cv_gt_reset_rx ./libraries/alt_cv_gt_reset_rx/
...
alias com {
  echo "\[exec\] com"
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_reset_control/altera_xcvr_functions.sv"            -work alt_cv_gt_reset_rx
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_reset_control/mentor/altera_xcvr_functions.sv"     -work alt_cv_gt_reset_rx
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_reset_control/alt_xcvr_resync.sv"                  -work alt_cv_gt_reset_rx
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_reset_control/mentor/alt_xcvr_resync.sv"           -work alt_cv_gt_reset_rx
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_reset_control/altera_xcvr_reset_control.sv"        -work alt_cv_gt_reset_rx
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_reset_control/alt_xcvr_reset_counter.sv"           -work alt_cv_gt_reset_rx
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_reset_control/mentor/altera_xcvr_reset_control.sv" -work alt_cv_gt_reset_rx
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_reset_control/mentor/alt_xcvr_reset_counter.sv"    -work alt_cv_gt_reset_rx
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/alt_cv_gt_reset_rx.vhd"                                                                
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L alt_cv_gt_reset_rx -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev $TOP_LEVEL_NAME
}
