...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_iopll_160/sim/frameclk_pll_altera_iopll_160_tnwlaai.vo" -work frameclk_pll_altera_iopll_160
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/frameclk_pll.v"                                                                                      
fi
