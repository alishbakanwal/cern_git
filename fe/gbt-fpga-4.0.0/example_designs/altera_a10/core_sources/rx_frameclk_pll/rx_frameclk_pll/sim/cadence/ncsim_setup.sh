...
TOP_LEVEL_NAME="rx_frameclk_pll"
QSYS_SIMDIR="./../"
...
mkdir -p ./libraries/rx_frameclk_pll_altera_iopll_151/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../altera_iopll_151/sim/rx_frameclk_pll_altera_iopll_151_zl46mda.vo" -work rx_frameclk_pll_altera_iopll_151 -cdslib ./cds_libs/rx_frameclk_pll_altera_iopll_151.cds.lib
  ncvlog -compcnfg $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/rx_frameclk_pll.v"                                                                                                                                                     
fi
