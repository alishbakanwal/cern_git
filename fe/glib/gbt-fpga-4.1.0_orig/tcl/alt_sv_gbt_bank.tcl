...
puts "-> Adding Altera Stratix V top to the Quartus II project..."
puts "->" 
set_global_assignment -name VHDL_FILE $SOURCE_PATH/example_designs/altera_sv/core_sources/alt_sv_gbt_example_design.vhd