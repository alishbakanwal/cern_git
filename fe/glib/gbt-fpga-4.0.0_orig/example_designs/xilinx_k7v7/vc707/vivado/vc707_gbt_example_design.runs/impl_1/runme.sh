...
HD_PWD=D:/gbt_fpga/example_designs/xilinx_k7v7/vc707/vivado/vc707_gbt_example_design.runs/impl_1
cd "$HD_PWD"
...
EAStep vivado -log vc707_gbt_example_design.vdi -applog -m64 -messageDb vivado.pb -mode batch -source vc707_gbt_example_design.tcl -notrace
