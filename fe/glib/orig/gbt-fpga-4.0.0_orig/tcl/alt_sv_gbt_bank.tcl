...
# Script Name:           Altera Stratix V - GBT Bank                                        
#                                                                                                 
...
puts "-> Adding Altera Stratix V specific files of the GBT-FPGA Core to the Quartus II project..."
puts "->" 


set_global_assignment -name VHDL_FILE $SOURCE_PATH/gbt_bank/altera_sv/alt_sv_gbt_banks_user_setup.vhd
set_global_assignment -name VHDL_FILE $SOURCE_PATH/gbt_bank/altera_sv/alt_sv_gbt_bank_package.vhd
  
set_global_assignment -name VHDL_FILE  $SOURCE_PATH/gbt_bank/altera_sv/gbt_rx/alt_sv_gbt_rx_gearbox_std_dpram.vhd
set_global_assignment -name QIP_FILE  $SOURCE_PATH/gbt_bank/altera_sv/gbt_rx/rx_dpram/alt_sv_rx_dpram.qip
  
set_global_assignment -name VHDL_FILE  $SOURCE_PATH/gbt_bank/altera_sv/gbt_tx/alt_sv_gbt_tx_gearbox_std_dpram.vhd
set_global_assignment -name QIP_FILE   $SOURCE_PATH/gbt_bank/altera_sv/gbt_tx/tx_dpram/alt_sv_tx_dpram.qip

set_global_assignment -name VHDL_FILE $SOURCE_PATH/gbt_bank/altera_sv/mgt/alt_sv_mgt_latopt.vhd
set_global_assignment -name VHDL_FILE $SOURCE_PATH/gbt_bank/altera_sv/mgt/alt_sv_mgt_resetctrl.vhd
set_global_assignment -name VHDL_FILE $SOURCE_PATH/gbt_bank/altera_sv/mgt/alt_sv_mgt_std.vhd

set_global_assignment -name QIP_FILE  $SOURCE_PATH/gbt_bank/altera_sv/mgt/gx_latopt_x1/alt_sv_gx_latopt_x1.qip
set_global_assignment -name QIP_FILE  $SOURCE_PATH/gbt_bank/altera_sv/mgt/gx_latopt_x2/alt_sv_gx_latopt_x2.qip
set_global_assignment -name QIP_FILE  $SOURCE_PATH/gbt_bank/altera_sv/mgt/gx_latopt_x3/alt_sv_gx_latopt_x3.qip
set_global_assignment -name QIP_FILE  $SOURCE_PATH/gbt_bank/altera_sv/mgt/gx_latopt_x4/gx_latopt_x4.qip
set_global_assignment -name QIP_FILE  $SOURCE_PATH/gbt_bank/altera_sv/mgt/gx_latopt_x5/gx_latopt_x5.qip
set_global_assignment -name QIP_FILE  $SOURCE_PATH/gbt_bank/altera_sv/mgt/gx_latopt_x6/gx_latopt_x6.qip

set_global_assignment -name QIP_FILE  $SOURCE_PATH/gbt_bank/altera_sv/mgt/gx_std_x1/alt_sv_gx_std_x1.qip
set_global_assignment -name QIP_FILE  $SOURCE_PATH/gbt_bank/altera_sv/mgt/gx_std_x2/alt_sv_gx_std_x2.qip
set_global_assignment -name QIP_FILE  $SOURCE_PATH/gbt_bank/altera_sv/mgt/gx_std_x3/alt_sv_gx_std_x3.qip
set_global_assignment -name QIP_FILE  $SOURCE_PATH/gbt_bank/altera_sv/mgt/gx_std_x4/gx_std_x4.qip
set_global_assignment -name QIP_FILE  $SOURCE_PATH/gbt_bank/altera_sv/mgt/gx_std_x5/gx_std_x5.qip
set_global_assignment -name QIP_FILE  $SOURCE_PATH/gbt_bank/altera_sv/mgt/gx_std_x6/gx_std_x6.qip

set_global_assignment -name QIP_FILE  $SOURCE_PATH/gbt_bank/altera_sv/mgt/mgt_reconfctrl_x1/alt_sv_gx_reconfctrl_x1.qip
set_global_assignment -name QIP_FILE  $SOURCE_PATH/gbt_bank/altera_sv/mgt/mgt_reconfctrl_x2/alt_sv_gx_reconfctrl_x2.qip
set_global_assignment -name QIP_FILE  $SOURCE_PATH/gbt_bank/altera_sv/mgt/mgt_reconfctrl_x3/alt_sv_gx_reconfctrl_x3.qip
set_global_assignment -name QIP_FILE  $SOURCE_PATH/gbt_bank/altera_sv/mgt/mgt_reconfctrl_x4/mgt_reconfctrl_x4.qip
set_global_assignment -name QIP_FILE  $SOURCE_PATH/gbt_bank/altera_sv/mgt/mgt_reconfctrl_x5/mgt_reconfctrl_x5.qip
set_global_assignment -name QIP_FILE  $SOURCE_PATH/gbt_bank/altera_sv/mgt/mgt_reconfctrl_x6/mgt_reconfctrl_x6.qip

set_global_assignment -name QIP_FILE  $SOURCE_PATH/gbt_bank/altera_sv/mgt/gx_reset_rx/alt_sv_gx_reset_rx.qip
set_global_assignment -name QIP_FILE  $SOURCE_PATH/gbt_bank/altera_sv/mgt/gx_reset_tx/alt_sv_gx_reset_tx.qip

set_global_assignment -name VHDL_FILE $SOURCE_PATH/gbt_bank/altera_sv/mgt/mgt_txpll/alt_sv_mgt_txpll.vhd
set_global_assignment -name QIP_FILE  $SOURCE_PATH/gbt_bank/altera_sv/mgt/mgt_txpll/gx_reset_txpll/alt_sv_gx_reset_txpll.qip
set_global_assignment -name QIP_FILE  $SOURCE_PATH/gbt_bank/altera_sv/mgt/mgt_txpll/gx_txpll/alt_sv_gx_txpll.qip


# Comment: Adding Altera Stratix V specific files:

puts "-> Adding Altera Stratix V RX Frameclk aligner to the Quartus II project..."
puts "->" 
...
set_global_assignment -name VHDL_FILE $SOURCE_PATH/example_designs/altera_sv/core_sources/gbt_rx_frameclk_phalgnr/phaligner_mmcm_controller.vhd
set_global_assignment -name VHDL_FILE $SOURCE_PATH/example_designs/altera_sv/core_sources/gbt_rx_frameclk_phalgnr/phalgnr_std_pll.vhd
set_global_assignment -name QIP_FILE  $SOURCE_PATH/example_designs/altera_sv/core_sources/gbt_rx_frameclk_phalgnr/gbt_rx_frameclk_phalgnr_pll/alt_sv_gbt_rx_frameclk_phalgnr_pll.qip


# Comment: Adding Altera Stratix V specific files:

puts "-> Adding Altera Stratix V Reset module to the Quartus II project..."
puts "->" 
set_global_assignment -name VHDL_FILE $SOURCE_PATH/example_designs/altera_sv/core_sources/reset/alt_sv_reset.vhd
set_global_assignment -name QIP_FILE  $SOURCE_PATH/example_designs/altera_sv/core_sources/reset/lpm_shiftreg/alt_sv_lpm_shiftreg.qip
set_global_assignment -name VHDL_FILE $SOURCE_PATH/example_designs/core_sources/gbt_bank_reset.vhd


# Comment: Adding Altera Stratix V specific files:

puts "-> Adding Altera Stratix V GBT Pattern Generator to the Quartus II project..."
puts "->" 
...
puts "-> Adding Altera Stratix V GBT Pattern checker to the Quartus II project..."
puts "->" 
...
puts "-> Adding Altera Stratix V Match Flag module to the Quartus II project..."
puts "->" 
...
puts "-> Adding Altera Stratix V QSYS component to the Quartus II directory..."
puts "->" 
...
while {[gets $in line] != -1} {
	if {[string first "set SOURCE_PATH" $line]!=-1} {
		...
		puts $out "#Files"
		puts $out "add_fileset_file alt_sv_gbt_example_design_qsys_wrapper.vhd VHDL PATH $SOURCE_PATH/example_designs/altera_sv/core_sources/alt_sv_gbt_example_design_qsys_wrapper.vhd TOP_LEVEL_FILE"
		puts $out "add_fileset_file alt_sv_gbt_example_design.vhd VHDL PATH $SOURCE_PATH/example_designs/altera_sv/core_sources/alt_sv_gbt_example_design.vhd"
	} elseif {[string first "set_fileset_property 	QUARTUS_SYNTH 	TOP_LEVEL" $line]!=-1} { 
		puts $out "set_fileset_property 	QUARTUS_SYNTH 	TOP_LEVEL alt_sv_gbt_example_design_qsys"
	} else {
		puts $out $line
	}    
}
