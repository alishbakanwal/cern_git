...
# ACDS 15.1 185 win32 2016.03.30.15:02:29
# ----------------------------------------
# Auto-generated simulation script rivierapro_setup.tcl
# ----------------------------------------
# This script can be used to simulate the following IP:
#     alt_cv_gbt_rx_frameclk_phalgnr_pll
...
# # End of template
# ----------------------------------------
# If alt_cv_gbt_rx_frameclk_phalgnr_pll is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "alt_cv_gbt_rx_frameclk_phalgnr_pll"
}
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/alt_cv_gbt_rx_frameclk_phalgnr_pll.vho"
}
