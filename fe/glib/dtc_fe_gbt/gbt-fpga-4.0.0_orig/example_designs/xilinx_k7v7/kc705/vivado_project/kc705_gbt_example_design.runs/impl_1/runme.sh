...
HD_PWD=D:/GBT-FPGA/trunk/example_designs/xilinx_k7v7/kc705/vivado_project/kc705_gbt_example_design.runs/impl_1
cd "$HD_PWD"
...
EAStep vivado -log kc705_gbt_example_design.vdi -applog -m64 -messageDb vivado.pb -mode batch -source kc705_gbt_example_design.tcl -notrace
