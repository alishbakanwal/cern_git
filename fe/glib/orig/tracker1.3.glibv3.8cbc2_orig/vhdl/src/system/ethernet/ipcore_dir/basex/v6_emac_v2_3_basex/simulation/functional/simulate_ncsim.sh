#!/bin/sh
mkdir work
ncvhdl -v93 -work work ../../../v6_emac_v2_3_basex.vhd
...
ncvhdl -v93 -work work ../../example_design/v6_emac_v2_3_basex_block.vhd
ncvhdl -v93 -work work ../../example_design/v6_emac_v2_3_basex_fifo_block.vhd
ncvhdl -v93 -work work ../../example_design/v6_emac_v2_3_basex_example_design.vhd
