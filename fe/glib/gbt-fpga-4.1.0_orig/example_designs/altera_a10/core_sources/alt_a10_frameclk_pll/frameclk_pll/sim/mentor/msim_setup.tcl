...
# ----------------------------------------
# If frameclk_pll is one of several IP cores in your
...
# ----------------------------------------
# ACDS 16.0 211 win32 2016.07.20.10:19:02
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "frameclk_pll"
}
...
ensure_lib                               ./libraries/frameclk_pll_altera_iopll_160/
vmap       frameclk_pll_altera_iopll_160 ./libraries/frameclk_pll_altera_iopll_160/
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_iopll_160/sim/frameclk_pll_altera_iopll_160_tnwlaai.vo" -work frameclk_pll_altera_iopll_160
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/frameclk_pll.v"                                                                                      
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L frameclk_pll_altera_iopll_160 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L frameclk_pll_altera_iopll_160 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
