...
alias com {
  echo "\[exec\] com"
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_xcvr_reset_control_151/sim/altera_xcvr_functions.sv"     -work gx_reset_tx_altera_xcvr_reset_control_151
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_xcvr_reset_control_151/sim/alt_xcvr_resync.sv"           -work gx_reset_tx_altera_xcvr_reset_control_151
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_xcvr_reset_control_151/sim/altera_xcvr_reset_control.sv" -work gx_reset_tx_altera_xcvr_reset_control_151
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_xcvr_reset_control_151/sim/alt_xcvr_reset_counter.sv"    -work gx_reset_tx_altera_xcvr_reset_control_151
...
alias elab_debug {
  ...
  eval vsim -dbg -O2 +access +r -t ps $ELAB_OPTIONS -L work -L gx_reset_tx_altera_xcvr_reset_control_151 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L twentynm -L twentynm_hssi -L twentynm_hip $TOP_LEVEL_NAME
}
