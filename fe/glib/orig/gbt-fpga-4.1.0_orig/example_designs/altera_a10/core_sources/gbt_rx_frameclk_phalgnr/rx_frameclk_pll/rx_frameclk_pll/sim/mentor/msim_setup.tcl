...
# ----------------------------------------
# ACDS 16.0 211 win32 2016.07.20.10:25:14
...
ensure_lib                                  ./libraries/rx_frameclk_pll_altera_iopll_160/
vmap       rx_frameclk_pll_altera_iopll_160 ./libraries/rx_frameclk_pll_altera_iopll_160/
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_iopll_160/sim/rx_frameclk_pll_altera_iopll_160_zwfcdta.vo" -work rx_frameclk_pll_altera_iopll_160
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/rx_frameclk_pll.vhd"                                                                                       
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L rx_frameclk_pll_altera_iopll_160 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L twentynm -L twentynm_hssi -L twentynm_hip $TOP_LEVEL_NAME
}
