...
vlog -work work clkDiv_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax clkDiv_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.clkDiv_tb work.glbl
