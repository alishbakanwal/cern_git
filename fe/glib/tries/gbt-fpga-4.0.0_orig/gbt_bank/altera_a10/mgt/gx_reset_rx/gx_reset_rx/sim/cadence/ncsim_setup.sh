...
mkdir -p ./libraries/gx_reset_rx_altera_xcvr_reset_control_151/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/../altera_xcvr_reset_control_151/sim/altera_xcvr_functions.sv"     -work gx_reset_rx_altera_xcvr_reset_control_151 -cdslib ./cds_libs/gx_reset_rx_altera_xcvr_reset_control_151.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/../altera_xcvr_reset_control_151/sim/alt_xcvr_resync.sv"           -work gx_reset_rx_altera_xcvr_reset_control_151 -cdslib ./cds_libs/gx_reset_rx_altera_xcvr_reset_control_151.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/../altera_xcvr_reset_control_151/sim/altera_xcvr_reset_control.sv" -work gx_reset_rx_altera_xcvr_reset_control_151 -cdslib ./cds_libs/gx_reset_rx_altera_xcvr_reset_control_151.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/../altera_xcvr_reset_control_151/sim/alt_xcvr_reset_counter.sv"    -work gx_reset_rx_altera_xcvr_reset_control_151 -cdslib ./cds_libs/gx_reset_rx_altera_xcvr_reset_control_151.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/gx_reset_rx.vhd"                                                                                                                                                                       
fi
