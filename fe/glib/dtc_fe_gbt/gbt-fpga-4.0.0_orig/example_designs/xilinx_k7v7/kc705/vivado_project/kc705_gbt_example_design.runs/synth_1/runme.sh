...
HD_PWD=D:/GBT-FPGA/trunk/example_designs/xilinx_k7v7/kc705/vivado_project/kc705_gbt_example_design.runs/synth_1
cd "$HD_PWD"
...
EAStep vivado -log kc705_gbt_example_design.vds -m64 -mode batch -messageDb vivado.pb -notrace -source kc705_gbt_example_design.tcl
