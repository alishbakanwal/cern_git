...
#cdce_settings[4] = 0xEB140334 # reg4 (out4= 40MHz after read
#cdce_settings[4] = 0xEB840334 # reg4 (out4= 240MHz,LVDS, R4.1=1, ph4adjc=0)
cdce_settings[4] = 0xEB820334 # reg4 (out4= 320MHz,LVDS, R4.1=1, ph4adjc=0)

#cdce_settings[5] = 0x013C0CF5 # reg5 (LVDS in, DC term, PRIM REF enable, SEC REF enable, smartMUX off, etc.)
cdce_settings[5] = 0x013C0FF5
...
cdce_settings[8] = 0x20009D78 # reg8 (various)}; # 0x20009d58 on DESY(be) / 0x20009D78 after read(be) iphc
