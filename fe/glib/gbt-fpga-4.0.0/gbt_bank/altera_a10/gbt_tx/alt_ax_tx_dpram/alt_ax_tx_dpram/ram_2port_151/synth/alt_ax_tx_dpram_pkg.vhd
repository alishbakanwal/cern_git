...
package alt_ax_tx_dpram_pkg is
	component alt_ax_tx_dpram_ram_2port_151_4prucuq is
		port (
			...
			q         : out std_logic_vector(19 downto 0)                      -- dataout
		);
	end component alt_ax_tx_dpram_ram_2port_151_4prucuq;

end alt_ax_tx_dpram_pkg;
