...
# # End of template
# ----------------------------------------
# If gx_reset_rx is one of several IP cores in your
...
# ----------------------------------------
# ACDS 15.1 185 linux 2016.03.15.11:13:43
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "gx_reset_rx"
}
...
ensure_lib                                           ./libraries/gx_reset_rx_altera_xcvr_reset_control_151/
vmap       gx_reset_rx_altera_xcvr_reset_control_151 ./libraries/gx_reset_rx_altera_xcvr_reset_control_151/
...
alias com {
  echo "\[exec\] com"
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_xcvr_reset_control_151/sim/altera_xcvr_functions.sv"            -work gx_reset_rx_altera_xcvr_reset_control_151
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_xcvr_reset_control_151/sim/mentor/altera_xcvr_functions.sv"     -work gx_reset_rx_altera_xcvr_reset_control_151
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_xcvr_reset_control_151/sim/alt_xcvr_resync.sv"                  -work gx_reset_rx_altera_xcvr_reset_control_151
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_xcvr_reset_control_151/sim/mentor/alt_xcvr_resync.sv"           -work gx_reset_rx_altera_xcvr_reset_control_151
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_xcvr_reset_control_151/sim/altera_xcvr_reset_control.sv"        -work gx_reset_rx_altera_xcvr_reset_control_151
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_xcvr_reset_control_151/sim/alt_xcvr_reset_counter.sv"           -work gx_reset_rx_altera_xcvr_reset_control_151
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_xcvr_reset_control_151/sim/mentor/altera_xcvr_reset_control.sv" -work gx_reset_rx_altera_xcvr_reset_control_151
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_xcvr_reset_control_151/sim/mentor/alt_xcvr_reset_counter.sv"    -work gx_reset_rx_altera_xcvr_reset_control_151
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/gx_reset_rx.vhd"                                                                                                         
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L gx_reset_rx_altera_xcvr_reset_control_151 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L twentynm -L twentynm_hssi -L twentynm_hip $TOP_LEVEL_NAME
}
