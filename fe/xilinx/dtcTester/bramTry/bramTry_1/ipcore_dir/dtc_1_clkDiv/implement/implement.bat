...
xst -ifn xst.scr
move dtc_1_clkDiv_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\dtc_1_clkDiv_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc dtc_1_clkDiv_exdes.ucf dtc_1_clkDiv_exdes

echo 'Running map'
map -timing -pr b dtc_1_clkDiv_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm dtc_1_clkDiv_exdes -w routed.ncd routed.v
cd ..
