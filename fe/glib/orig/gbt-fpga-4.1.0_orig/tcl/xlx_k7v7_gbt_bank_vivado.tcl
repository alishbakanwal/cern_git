...
#
#                        20/02/2016   4.0       J. Mendez         First .tcl script definition
#                        20/07/2016   4.1       J. Mendez         New transceivers implementation
#
...
add_files $SOURCE_PATH/gbt_bank/xilinx_k7v7/mgt/mgt_ip_vhd/xlx_k7v7_mgt_ip.vhd
add_files $SOURCE_PATH/gbt_bank/xilinx_k7v7/mgt/mgt_ip_vhd/xlx_k7v7_mgt_ip_auto_phase_align.vhd
add_files $SOURCE_PATH/gbt_bank/xilinx_k7v7/mgt/mgt_ip_vhd/xlx_k7v7_mgt_ip_cpll_railing.vhd
add_files $SOURCE_PATH/gbt_bank/xilinx_k7v7/mgt/mgt_ip_vhd/xlx_k7v7_mgt_ip_gt.vhd
add_files $SOURCE_PATH/gbt_bank/xilinx_k7v7/mgt/mgt_ip_vhd/xlx_k7v7_mgt_ip_init.vhd
add_files $SOURCE_PATH/gbt_bank/xilinx_k7v7/mgt/mgt_ip_vhd/xlx_k7v7_mgt_ip_multi_gt.vhd
add_files $SOURCE_PATH/gbt_bank/xilinx_k7v7/mgt/mgt_ip_vhd/xlx_k7v7_mgt_ip_rx_startup_fsm.vhd
add_files $SOURCE_PATH/gbt_bank/xilinx_k7v7/mgt/mgt_ip_vhd/xlx_k7v7_mgt_ip_sync_block.vhd
add_files $SOURCE_PATH/gbt_bank/xilinx_k7v7/mgt/mgt_ip_vhd/xlx_k7v7_mgt_ip_sync_pulse.vhd
add_files $SOURCE_PATH/gbt_bank/xilinx_k7v7/mgt/mgt_ip_vhd/xlx_k7v7_mgt_ip_tx_manual_phase_align.vhd
add_files $SOURCE_PATH/gbt_bank/xilinx_k7v7/mgt/mgt_ip_vhd/xlx_k7v7_mgt_ip_tx_startup_fsm.vhd
...
puts "-> Adding Xilinx Kintex 7 & Virtex 7 RX Frameclk aligner to the Quartus II project..."
puts "->" 
...
add_files $SOURCE_PATH/example_designs/xilinx_k7v7/core_sources/gbt_rx_frameclk_phalgnr/xlx_k7v7_phalgnr_std_mmcm.vhd
add_files $SOURCE_PATH/example_designs/xilinx_k7v7/core_sources/gbt_rx_frameclk_phalgnr/phaligner_mmcm_controller.vhd
import_ip $SOURCE_PATH/example_designs/xilinx_k7v7/core_sources/gbt_rx_frameclk_phalgnr/vivado/xlx_k7v7_gbt_rx_frameclk_phalgnr_mmcm.xci -name xlx_k7v7_gbt_rx_frameclk_phalgnr_mmcm

puts "-> Adding Xilinx Kintex 7 & Virtex 7 Reset module to the Quartus II project..."
puts "->" 

add_files $SOURCE_PATH/example_designs/core_sources/gbt_bank_reset.vhd

puts "-> Adding Xilinx Kintex 7 & Virtex 7 GBT Pattern Generator to the Quartus II project..."
puts "->" 
add_files $SOURCE_PATH/example_designs/core_sources/gbt_pattern_generator.vhd

puts "-> Adding Xilinx Kintex 7 & Virtex 7 GBT Pattern checker to the Quartus II project..."
puts "->" 
add_files $SOURCE_PATH/example_designs/core_sources/gbt_pattern_checker.vhd

puts "-> Adding Xilinx Kintex 7 & Virtex 7 Match Flag module to the Quartus II project..."
puts "->" 
add_files $SOURCE_PATH/example_designs/core_sources/gbt_pattern_matchflag.vhd

puts "-> Adding Xilinx Kintex 7 & Virtex 7 top to the Quartus II project..."
puts "->" 
add_files $SOURCE_PATH/example_designs/xilinx_k7v7/core_sources/xlx_k7v7_gbt_example_design.vhd
