...
mkdir -p ./libraries/rx_frameclk_pll_altera_iopll_160/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/../altera_iopll_160/sim/rx_frameclk_pll_altera_iopll_160_zwfcdta.vo" -work rx_frameclk_pll_altera_iopll_160 -cdslib ./cds_libs/rx_frameclk_pll_altera_iopll_160.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/rx_frameclk_pll.vhd"                                                                                                                                                   
fi
