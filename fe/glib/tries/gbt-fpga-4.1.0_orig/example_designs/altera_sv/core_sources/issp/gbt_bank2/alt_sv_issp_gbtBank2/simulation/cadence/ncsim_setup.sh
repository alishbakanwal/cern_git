...
TOP_LEVEL_NAME="alt_sv_issp_gbtBank2"
QSYS_SIMDIR="./../"
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/altsource_probe.v" -work in_system_sources_probes_0 -cdslib ./cds_libs/in_system_sources_probes_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/alt_sv_issp_gbtBank2.vhd"                                                                                           
fi
