...
# ACDS 16.0 211 win32 2016.07.20.11:41:53
# ----------------------------------------
# Auto-generated simulation script rivierapro_setup.tcl
# ----------------------------------------
# This script provides commands to simulate the following IP detected in
# your Quartus project:
#     gbt_tx_frameclk_stdpll
# 
...
# ----------------------------------------
# If gbt_tx_frameclk_stdpll is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "gbt_tx_frameclk_stdpll"
}
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/gbt_tx_frameclk_stdpll.vho"
}
