...
xst -ifn xst.scr
move mmcm1_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\mmcm1_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc mmcm1_exdes.ucf mmcm1_exdes

echo 'Running map'
map -timing -pr b mmcm1_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm mmcm1_exdes -w routed.ncd routed.vhd
cd ..
