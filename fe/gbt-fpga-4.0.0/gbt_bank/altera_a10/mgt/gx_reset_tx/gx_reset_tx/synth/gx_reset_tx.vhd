...
use gx_reset_tx_altera_xcvr_reset_control_151.gx_reset_tx_pkg.all;
...
begin
	...
	xcvr_reset_control_0 : component gx_reset_tx_altera_xcvr_reset_control_151.gx_reset_tx_pkg.altera_xcvr_reset_control
		generic map (
			CHANNELS              => 1,
			PLLS                  => 1,
			SYS_CLK_IN_MHZ        => 240,
