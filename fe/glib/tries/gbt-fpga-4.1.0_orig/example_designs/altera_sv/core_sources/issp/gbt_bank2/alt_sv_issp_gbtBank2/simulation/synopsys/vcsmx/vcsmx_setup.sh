...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/submodules/altsource_probe.v" -work in_system_sources_probes_0
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/alt_sv_issp_gbtBank2.vhd"                                     
fi
