...
xst -ifn xst.scr
copy /B v6_emac_v2_3_sgmii_example_design.ngc results\

# Copy the EDIF's generated by Coregen
echo 'Copying files from the netlist directory to the results directory';
copy /B ..\..\v6_emac_v2_3_sgmii.ngc results\

echo 'Copying files from constraints directory to results directory'
copy /B ..\example_design\v6_emac_v2_3_sgmii_example_design.ucf results\
...
echo 'Running map'
map -ol high -timing v6_emac_v2_3_sgmii_example_design -o mapped.ncd
