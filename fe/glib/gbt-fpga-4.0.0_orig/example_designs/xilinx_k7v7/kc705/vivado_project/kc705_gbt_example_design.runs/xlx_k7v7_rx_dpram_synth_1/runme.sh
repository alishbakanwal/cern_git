...
HD_PWD=D:/GBT-FPGA/trunk/example_designs/xilinx_k7v7/kc705/vivado_project/kc705_gbt_example_design.runs/xlx_k7v7_rx_dpram_synth_1
cd "$HD_PWD"
...
EAStep vivado -log xlx_k7v7_rx_dpram.vds -m64 -mode batch -messageDb vivado.pb -notrace -source xlx_k7v7_rx_dpram.tcl
