...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/../altera_iopll_151/sim/frameclk_pll_altera_iopll_151_va2pmui.vo" -work frameclk_pll_altera_iopll_151
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/frameclk_pll.vhd"                                                                                    
fi
