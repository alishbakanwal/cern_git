set SOURCE_PATH D:/cern/glib/dtc_fe_gbt

#puts "->"
#puts "-> Adding GLIB firmware files to ISE"
#puts "->"
...
#xfile add $SOURCE_PATH/tracker1.3.glibv3.8cbc2/vhdl/src/user/iphc_strasbourg/be/cbc_frame_transmission.vhd
#xfile add $SOURCE_PATH/tracker1.3.glibv3.8cbc2/vhdl/src/user/iphc_strasbourg/be/cbc_i2c_updating_ctrl_v4.vhd
#xfile add $SOURCE_PATH/tracker1.3.glibv3.8cbc2/vhdl/src/user/iphc_strasbourg/be/gbt_data_interface_be.vhd
#xfile add $SOURCE_PATH/tracker1.3.glibv3.8cbc2/vhdl/src/system/sys/glib_top.vhd
#xfile add $SOURCE_PATH/tracker1.3.glibv3.8cbc2/vhdl/src/system/sys/glib_top.vhd


puts "->"
puts "-> Adding DTC files"
puts "->"

#
# dtc_fe files
#
#xfile add $SOURCE_PATH/dtc_3.0/dtc_fe.v
#xfile add $SOURCE_PATH/dtc_3.0/dtc_3.0/eports_trig.v

#xfile add $SOURCE_PATH/dtc_3.0/clkDiv.xco
#xfile add $SOURCE_PATH/dtc_3.0/dtc_buff.xco
#xfile add $SOURCE_PATH/dtc_3.0/cicbram.xco
#xfile add $SOURCE_PATH/dtc_3.0/icon.xco
#xfile add $SOURCE_PATH/dtc_3.0/ila.xco
...
set SOURCE_PATH D:/cern/glib/dtc_fe_gbt/gbt-fpga-4.0.0_orig
