...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/../altera_iopll_160/sim/rx_frameclk_pll_altera_iopll_160_zwfcdta.vo" -work rx_frameclk_pll_altera_iopll_160
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/rx_frameclk_pll.vhd"                                                                                       
fi
