...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_iopll_151/sim/rx_frameclk_pll_altera_iopll_151_zl46mda.vo" -work rx_frameclk_pll_altera_iopll_151
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/rx_frameclk_pll.v"                                                                                         
fi
