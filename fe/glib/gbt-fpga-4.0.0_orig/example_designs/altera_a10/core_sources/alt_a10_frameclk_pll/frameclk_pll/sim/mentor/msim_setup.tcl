...
# ----------------------------------------
# ACDS 15.1 185 win32 2016.04.18.12:04:15
...
ensure_lib                               ./libraries/frameclk_pll_altera_iopll_151/
vmap       frameclk_pll_altera_iopll_151 ./libraries/frameclk_pll_altera_iopll_151/
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_iopll_151/sim/frameclk_pll_altera_iopll_151_va2pmui.vo" -work frameclk_pll_altera_iopll_151
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/frameclk_pll.vhd"                                                                                    
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L frameclk_pll_altera_iopll_151 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L twentynm -L twentynm_hssi -L twentynm_hip $TOP_LEVEL_NAME
}
