...
library IEEE;
library gx_reset_rx_altera_xcvr_reset_control_160;
use IEEE.std_logic_1164.all;
use IEEE.numeric_std.all;
use gx_reset_rx_altera_xcvr_reset_control_160.gx_reset_rx_pkg.all;
...
begin
	...
	xcvr_reset_control_0 : component gx_reset_rx_altera_xcvr_reset_control_160.gx_reset_rx_pkg.altera_xcvr_reset_control
		generic map (
			CHANNELS              => 1,
			PLLS                  => 1,
			SYS_CLK_IN_MHZ        => 240,
