...
HD_PWD=D:/gbt_fpga/example_designs/xilinx_k7v7/vc707/vivado/vc707_gbt_example_design.runs/synth_1
cd "$HD_PWD"
...
EAStep vivado -log vc707_gbt_example_design.vds -m64 -mode batch -messageDb vivado.pb -notrace -source vc707_gbt_example_design.tcl
