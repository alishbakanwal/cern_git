...
xst -ifn xst.scr
move sr_doubleBuffered_clkDiv_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\sr_doubleBuffered_clkDiv_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc sr_doubleBuffered_clkDiv_exdes.ucf sr_doubleBuffered_clkDiv_exdes

echo 'Running map'
map -timing -pr b sr_doubleBuffered_clkDiv_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm sr_doubleBuffered_clkDiv_exdes -w routed.ncd routed.v
cd ..
