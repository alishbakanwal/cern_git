...
xst -ifn xst.scr
move clkDivider_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clkDivider_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clkDivider_exdes.ucf clkDivider_exdes

echo 'Running map'
map -timing -pr b clkDivider_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm clkDivider_exdes -w routed.ncd routed.v
cd ..
