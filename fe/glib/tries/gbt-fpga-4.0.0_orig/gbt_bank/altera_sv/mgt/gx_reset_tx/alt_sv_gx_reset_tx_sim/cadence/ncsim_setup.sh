...
TOP_LEVEL_NAME="alt_sv_gx_reset_tx"
QSYS_SIMDIR="./../"
...
mkdir -p ./libraries/alt_sv_gx_reset_tx/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/altera_xcvr_reset_control/altera_xcvr_functions.sv"     -work alt_sv_gx_reset_tx -cdslib ./cds_libs/alt_sv_gx_reset_tx.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/altera_xcvr_reset_control/alt_xcvr_resync.sv"           -work alt_sv_gx_reset_tx -cdslib ./cds_libs/alt_sv_gx_reset_tx.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/altera_xcvr_reset_control/altera_xcvr_reset_control.sv" -work alt_sv_gx_reset_tx -cdslib ./cds_libs/alt_sv_gx_reset_tx.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/altera_xcvr_reset_control/alt_xcvr_reset_counter.sv"    -work alt_sv_gx_reset_tx -cdslib ./cds_libs/alt_sv_gx_reset_tx.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/alt_sv_gx_reset_tx.vhd"                                                                                                       
fi
