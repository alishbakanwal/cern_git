...
# ----------------------------------------
# If frmclk_pll is one of several IP cores in your
...
# ----------------------------------------
# ACDS 16.0 211 win32 2016.07.20.14:39:25
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/frmclk_pll.vho"
}
