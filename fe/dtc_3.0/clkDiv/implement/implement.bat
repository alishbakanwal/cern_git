...
xst -ifn xst.scr
move clkDiv_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clkDiv_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clkDiv_exdes.ucf clkDiv_exdes

echo 'Running map'
map -timing -pr b clkDiv_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm clkDiv_exdes -w routed.ncd routed.v
cd ..
