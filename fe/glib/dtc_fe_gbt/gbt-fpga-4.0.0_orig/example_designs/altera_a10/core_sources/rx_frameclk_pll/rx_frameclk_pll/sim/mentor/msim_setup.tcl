...
# # End of template
# ----------------------------------------
# If rx_frameclk_pll is one of several IP cores in your
...
# ----------------------------------------
# ACDS 15.1 185 win32 2016.04.18.12:12:26
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "rx_frameclk_pll"
}
...
ensure_lib                                  ./libraries/rx_frameclk_pll_altera_iopll_151/
vmap       rx_frameclk_pll_altera_iopll_151 ./libraries/rx_frameclk_pll_altera_iopll_151/
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_iopll_151/sim/rx_frameclk_pll_altera_iopll_151_zl46mda.vo" -work rx_frameclk_pll_altera_iopll_151
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/rx_frameclk_pll.v"                                                                                         
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L rx_frameclk_pll_altera_iopll_151 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L rx_frameclk_pll_altera_iopll_151 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
